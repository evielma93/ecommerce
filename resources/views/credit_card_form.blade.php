                    ...
                    <div class="tab-content">
                        ...
                        <div id="nav-tab-card" class="tab-pane fade show active">
                            <form role="form" action="{{ route("billing.process_credit_card") }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-4">
                                            <label data-toggle="tooltip" title="{{ __("Introduce los 3 digitos de seguridad de tu tarjeta") }}">{{ __("CVC") }}
                                ...
                                <button type="submit" class="subscribe btn btn-primary btn-block rounded-pill shadow-sm">{{ __("Guardar tarjeta") }}</button>
                            </form>
                        </div>
                        <!-- End -->
                    </div>
